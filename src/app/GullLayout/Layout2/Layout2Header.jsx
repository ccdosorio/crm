  ...
  componentDidMount() {
    AsyncStorage.getItem(key)
      .then((response) => {
        ...
        //  console.log("respuesta Sesion",this.state.response_signin)
        let nombre = this.state.response_signin.nombre;
        ...
        if (rol === -1) {
          this.setState({ rolusuario: "ADMINISTRADOR" });
        } else if (rol === 5) {
          this.setState({ rolusuario: "EJECUTIVO AGENCIAS" });
        } else if (rol === 7) {
          this.setState({ rolusuario: "EJECUTIVO DIRECTOS" });
        } else if (rol === 16) {
          this.setState({ rolusuario: "EJECUTIVO REGIONALES" });
        } else {
          this.setState({ rolusuario: "USUARIO" });
        }

        this.listAvatar(idusuario);
      })
            ...
            <Dropdown>
              ...
              <DropdownMenu>
                <div className="dropdown-header">
                  ...
                  {this.state.response_signin.nombre}
                </div>
                <div className="dropdown-header">{this.state.rolusuario}</div>
