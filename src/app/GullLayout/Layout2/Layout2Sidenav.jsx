...
class Layout2Sidenav extends Component {
  windowListener = null;
  state = {
    banderaTour: localStorage.getItem("bandera"),
    isTourOpen: false,
    steps: [
      {
        selector: "#menu-crm",
        content: "Menú de opciones",
      },
      {
        selector: "#submenu-crm",
        content: "Sub-menú de opciones",
      },
      {
        selector: "#boton-menu",
        content: "Haga click aquí para Ocultar/Mostrar el menú de opciones",
      },
      {
        selector: "#pantalla-completa",
        content: "Haga click aquí para colocar la pantalla en modo full",
      },
      {
        selector: "#menu-perfil",
        content: "Haga click aquí para ver el menu del perfil",
      },
    ],
    selectedItem: {},
    navOpen: true,
  ...
  componentDidMount() {
    if (this.state.banderaTour == "false") {
      this.toggleTour();
    } else {
  ...
  render() {
    ...
    let { selectedItem, steps, isTourOpen } = this.state;
    ...
    return (
      <div className="side-content-wrap">
        ...
        >
          <ul className="navigation-left" id="menu-crm">
        ...
        >
          ...
          <div className="logo ml-4 mb-4">
            <img src="/assets/images/ndd-logo.png" alt="logo" />
          </div>
